  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-black text-white font-display uppercase">Collectibles V2</h1>
          <p className="text-zinc-500 font-mono text-sm mt-1">
            Experimental real NFT images with resilient fallback • {totalCount.toLocaleString()} total
          </p>
        </div>
      </div>
